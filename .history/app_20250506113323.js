...
function MenuCrud() {
    ...
    function removerVogais(palavra){
        palavra = readline.question("ddigite uma frase que vc seseja remover as vogais");
        if(palavra.match(/[aeiou]/)){
           console.log(palavra.replace(" 00"));
        }
    
    }


console.log(removerVogais());
